...
CRC16_CCITT.prototype.check = function(resp) {
...
CRC16_CCITT.prototype.calculate = function(bytes){
	...
	crc =this.ReflectGeneric(crc, width);
    return ((crc ^ this._finalXorVal) & this._castMask);
}

CRC16_CCITT.prototype.ReflectGeneric = function(val, width){
    var resByte = 0;
...
CRC16_CCITT.prototype.Reflect8 = function(val){
    var resByte = 0;
